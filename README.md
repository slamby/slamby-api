...
3. Download our Docker Compose file
  ```
  $ curl -L "https://github.com/slamby/slamby-api/releases/download/v1.6.1/docker-compose.yml" > docker-compose.yml
  ``` 
...
```
docker pull slamby/slamby.api:1.6.1
```
